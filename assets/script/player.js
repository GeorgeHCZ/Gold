cc.Class({
    ...
    onLoad: function () {
        ...
        //绳子收回动作，绳子收回后执行摇摆动作
        this.returnAction = cc.sequence(cc.moveTo(1,this.startPos),cc.callFunc(function() {
        ...
        this.node.on('touchstart',function(){
            ...
            //绳子伸长动作，根据角度动态计算
            self.rope.runAction(cc.moveBy(1,-470*Math.tan(Math.PI/180*this.rope.rotation),-470));
        },this);
